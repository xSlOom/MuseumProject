    ...
    <body>
        <nav>
            <div class="nav-wrapper">
                ...
                <ul id="nav-mobile" class="left hide-on-med-and-down">
                    ...
                    <li><a href="search.php">Rechercher des musées</a></li>
                </ul>
        ...
        <div class="container">
			...
			$nom = preg_replace("/[^a-zA-Z0-9s]/", "", $_POST["nom"]);
                        ...
                        if (sizeof($data) < 1):
                            print "<h4 class=\"center header\">Rien n'a été trouvé.</h4>";
                        else:
                            print "<h4 class=\"center header\">". sizeof($data) . " résultat(s) trouvé(s): </h4>";
